...
[source,groovy]
----
implementation('com.github.Natureknight.SimpleLock:simplelock-spring-starter:1.0.10')
----
...
- Added Create Release GitHub action
...
- Added `LockRunnableExecutor` and default implementation
