...
| `simplelock.jdbc.expiry.release-strategy`    | Whether the release strategy is with_delay or without_delay   | `true`
| `simplelock.jdbc.expiry.min-delay`    | Expiry delay                                                | `true`
| `simplelock.jdbc.expiry.time-unit`    | Time unit of the expiry delay                               | `true`
|===
...
| `simplelock.mongo.expiry.release-strategy`    | Whether the release strategy is with_delay or without_delay   | `true`
| `simplelock.mongo.expiry.min-delay`    | Expiry delay                                                | `true`
| `simplelock.mongo.expiry.time-unit`    | Time unit of the expiry delay                               | `true`
|===
...
Use the BOM `com.github.natureknight.simplelock:simplelock-dependencies:3.0.0` or add the project dependency into your `pom.xml` for SQL:
[source,xml]
...
depedencyManagement {
    imports {
        mavenBom 'com.github.natureknight.simplelock:simplelock-dependencies:3.0.0'
    }
}
...
----
implementation('com.github.natureknight.simplelock:simplelock-spring-starter-jdbc:3.0.0')
// or
implementation('com.github.natureknight.simplelock:simplelock-spring-starter-mongo:3.0.0')
----
