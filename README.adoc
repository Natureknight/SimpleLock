...
| `simplelock.jdbc.auto-generate-ddl`  | Whether to automatically create the DDL                       | `true`
|===
...
Use the BOM `com.github.natureknight.simplelock:simplelock-dependencies:2.1.0` or add the project dependency into your `pom.xml` for SQL:
[source,xml]
...
depedencyManagement {
    imports {
        mavenBom 'com.github.natureknight.simplelock:simplelock-dependencies:2.1.0'
    }
}
...
----
implementation('com.github.natureknight.simplelock:simplelock-spring-starter-jdbc:2.1.0')
// or
implementation('com.github.natureknight.simplelock:simplelock-spring-starter-mongo:2.1.0')
----
