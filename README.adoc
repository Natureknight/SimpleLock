...
or another approach, where you're allowed to propagate the lock token further into your service and release the lock
...
[source,groovy]
----
implementation('com.github.natureknight.simplelock:simplelock-spring-starter:1.2.7')
----
