...
Use the BOM `com.github.natureknight.simplelock:simplelock-dependencies:3.1.1` or add the project dependency into your `pom.xml` for SQL:
[source,xml]
...
depedencyManagement {
    imports {
        mavenBom 'com.github.natureknight.simplelock:simplelock-dependencies:3.1.1'
    }
}
...
----
implementation('com.github.natureknight.simplelock:simplelock-spring-starter-jdbc:3.1.1')
// or
implementation('com.github.natureknight.simplelock:simplelock-spring-starter-mongo:3.1.1')
----
